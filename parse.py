...
def get_arguments():
    ...
    parser.add_argument('--alpha', type=float, help='Reconstruction loss weight', default=1)
    parser.add_argument('--alpha_scale_factor', type=float, help='Reconstruction loss weight', default=1)
    ...
    # Baseline Parameters
    parser.add_argument('--N_baseline', type=int, help='Number of convolution layers for baseline', default=32)
