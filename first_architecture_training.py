...
class PyramidGAN:
    ...
    def train_scale(self, netG, netD, opt):
        ...
        for epoch in range(opt.niter):
            ...
            errG, errD, D_real, D_fake, rec_loss, z_opt, z_prev = self.train_epoch(netG, netD, optimizerG, optimizerD, real, style, m_noise, m_image, epoch, z_opt, z_prev, opt)
    ...
    def train_epoch(self, netG, netD, optimizerG, optimizerD, real, style, m_noise, m_image, epoch, z_opt, z_prev, opt):
        ...
        for j in range(opt.Dsteps):
            ...
            gradient_penalty = calc_gradient_penalty(netD, style, fake, opt.lambda_grad, opt.device)
        ...
        for j in range(opt.Gsteps):
            ...
            if opt.alpha != 0:
                ...
                rec_loss = opt.alpha * loss(netG(noise.detach(), prev, m_real.detach()), real)
